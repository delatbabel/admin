...
class MenuTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp()
    {
        ...
        $this->configFactory = m::mock('Delatbabel\Admin\Config\Factory');
        $this->menu = m::mock('Delatbabel\Admin\Menu', array($this->config, $this->configFactory))->makePartial();
    }
    ...
    public function testGetMenuSimpleReturnWithPermission()
    {
        ...
        $itemconfig = m::mock('Delatbabel\Admin\Config\Config');
