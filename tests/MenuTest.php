...
class MenuTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp()
    {
        ...
        $this->configFactory = m::mock('DDPro\Admin\Config\Factory');
        $this->menu = m::mock('DDPro\Admin\Menu', array($this->config, $this->configFactory))->makePartial();
    }
    ...
    public function testGetMenuSimpleReturnWithPermission()
    {
        ...
        $itemconfig = m::mock('DDPro\Admin\Config\Config');
